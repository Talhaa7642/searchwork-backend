...
export class InitialMigrations1737029406333 implements MigrationInterface {
  name: string = 'InitialMigrations1737029406333';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9dc9c02c4f76ca361095b73492" ON "location" ("latitude") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b3c57d30acba84d0de84146682" ON "location" ("longitude") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_job_status_enum" AS ENUM('applied', 'hiring', 'rejected', 'accepted', 'closed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."job_post_status_enum" AS ENUM('applied', 'hiring', 'rejected', 'accepted', 'closed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "feedback" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "feedback_text" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_8389f9e087a57689cd5be8b2b13" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "support_ticket" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "issue_title" character varying NOT NULL, "issue_description" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'open', "priority" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_506b4b9f579fb3adbaebe3950c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('employee', 'employer', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_6a629b014ebdc48eff6784fe4a" ON "user" ("email", "phone_number") `,
    );
    await queryRunner.query(
      `ALTER TABLE "job_seeker" ADD CONSTRAINT "FK_0f8b08fb61217cfd889046c1481" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_job" ADD CONSTRAINT "FK_f73d11ee54c1e4edd5d67264922" FOREIGN KEY ("job_post_id") REFERENCES "job_post"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_job" ADD CONSTRAINT "FK_94dc643d3b7d4636c7e95cb426c" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "saved_job" ADD CONSTRAINT "FK_49a5d9ceba0170864ccb720c3cb" FOREIGN KEY ("job_post_id") REFERENCES "job_post"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" ADD CONSTRAINT "FK_9edc44054a5429e48c8d0773176" FOREIGN KEY ("job_post_id") REFERENCES "job_post"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job_post" ADD CONSTRAINT "FK_9633ba5a15d7f485f0aaedc650a" FOREIGN KEY ("employer_id") REFERENCES "employer"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "support_ticket" ADD CONSTRAINT "FK_cb2e00c16c925e889f6e2dc2a4b" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "support_ticket" DROP CONSTRAINT "FK_cb2e00c16c925e889f6e2dc2a4b"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job_post" DROP CONSTRAINT "FK_9633ba5a15d7f485f0aaedc650a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" DROP CONSTRAINT "FK_928b7aa1754e08e1ed7052cb9d8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" DROP CONSTRAINT "FK_9edc44054a5429e48c8d0773176"`,
    );
    await queryRunner.query(
      `ALTER TABLE "saved_job" DROP CONSTRAINT "FK_49a5d9ceba0170864ccb720c3cb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "saved_job" DROP CONSTRAINT "FK_dc2c64f40719148d79921d424ba"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_job" DROP CONSTRAINT "FK_94dc643d3b7d4636c7e95cb426c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_job" DROP CONSTRAINT "FK_f73d11ee54c1e4edd5d67264922"`,
    );
    await queryRunner.query(
      `ALTER TABLE "job_seeker" DROP CONSTRAINT "FK_0f8b08fb61217cfd889046c1481"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6a629b014ebdc48eff6784fe4a"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b3c57d30acba84d0de84146682"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9dc9c02c4f76ca361095b73492"`,
    );
